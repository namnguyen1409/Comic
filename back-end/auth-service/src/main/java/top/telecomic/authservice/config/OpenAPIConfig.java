...
public class OpenAPIConfig {
    ...
    OpenAPI openAPI() {
        return new OpenAPI()
                ...
                .servers(
                        List.of(
                                new Server().url("http://localhost:8762")
                                        .description("Local Development Server"),
                                new Server().url("https://auth-service.telecomic.top")
                ...
                .info(new Info()
                        ...
                        .version("v1")
                        .description("API documentation for the Auth Service, which handles user authentication and authorization.")
                );
    }
