...
public record EndpointResponse(String serviceName, String path, String method, String description, Set<PermissionResponse> permissions, Boolean isPublic) implements Serializable {
  }